...
The program then uses the 10 numbers inserted by the user to carry out the following tasks:
      ...
      3.  Find the index of the minimum and print the result. 
      4.  Calculate the average (mean) of the numbers and round off to two decimal places and print the result. 
      5.  Find the median number and print the result. 
